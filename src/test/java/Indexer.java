...
import com.dave.invertedindex.index.IndexWriter;
...
public final class Indexer {
    ...
    private Document createDocument(String id, String title, String body) {
        ...
        field = new Field(FieldName.BODY.toString(), body, new FieldInfo(true, false, CommonTokenizer.class));
        doc.addField(field);
